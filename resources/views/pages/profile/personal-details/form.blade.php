{!! Form::model($employee, ['method' => 'PATCH', 'url' => str_replace('/edit', '', \Request::path()), 'class' => 'form-horizontal', 'onSubmit' => 'checkEmployeeId()', 'id' => 'personalDetailsForm']) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            {!! Form::select('marital_status_id', HRis\MaritalStatus::lists('name', 'id'), $employee->marital_status_id, ['class' => 'form-control chosen-select', $disabled]) !!}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            {!! Form::select('nationality_id', HRis\Nationality::lists('name', 'id'), $employee->nationality_id, ['class' => 'form-control chosen-select', $disabled]) !!}
        </div>
