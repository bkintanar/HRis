{!! Form::model($employee, ['method' => 'PATCH', 'url' => str_replace('/edit', '', Request::path()), 'class' => 'form-horizontal', 'onSubmit' => 'checkEmployeeId()', 'id' => 'personalDetailsForm']) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            {!! Form::select('marital_status_id', HRis\Eloquent\MaritalStatus::lists('name', 'id'), $employee->marital_status_id, ['placeholder' => '--- Select ---', 'class' => 'form-control chosen-select', $disabled]) !!}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            {!! Form::select('nationality_id', HRis\Eloquent\Nationality::lists('name', 'id'), $employee->nationality_id, ['placeholder' => '--- Select ---', 'class' => 'form-control chosen-select', $disabled]) !!}
        </div>
