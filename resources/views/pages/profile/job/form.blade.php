    ...
    <h4>Employment Commencement</h4><br />
        <div class="form-group">
                ...
                <div class="col-md-4" id="datepicker">
                        ...
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>{!! Form::text('joined_date', $employee->joined_date ? $employee->joined_date->toDateString() : null, ['class' => 'form-control form-fields', 'data-mask' => '9999-99-99', $disabled]) !!}
                        </div>
                </div>
                ...
                <div class="col-md-4" id="datepicker">
                        <div class="input-group date">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>{!! Form::text('probation_end_date', $employee->probation_end_date ? $employee->probation_end_date->toDateString() : null, ['class' => 'form-control form-fields', 'data-mask' => '9999-99-99', $disabled]) !!}
                        </div>
                </div>
        </div>
        ...
        <div class="form-group">
                ...
                <div class="col-md-4" id="datepicker">
                        <div class="input-group date" id="data_1">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>{!! Form::text('permanency_date', $employee->permanency_date ? $employee->permanency_date->toDateString() : null, ['class' => 'form-control form-fields', 'data-mask' => '9999-99-99', $disabled]) !!}
                        </div>
                </div>
        </div>
    <div class="hr-line-dashed"></div>
