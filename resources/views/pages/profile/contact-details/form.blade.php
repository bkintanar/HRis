{!! Form::model($employee, ['method' => 'PATCH', 'url' => str_replace('/edit', '', \Request::path()), 'class' => 'form-horizontal']) !!}
    ...
    <div class="form-group">
            ...
            <div class="col-md-4">
                {!! Form::select('address_city_id', HRis\City::lists('name', 'id'), $employee->address_city_id, ['class' => 'form-control chosen-select', $disabled]) !!}
            </div>

            {!! Form::label('address_province_id', 'Province', ['class' => 'col-md-2 control-label']) !!}
            <div class="col-md-4">
                {!! Form::select('address_province_id', HRis\Province::lists('name', 'id'), $employee->address_province_id, ['class' => 'form-control chosen-select', $disabled]) !!}
            </div>
    </div>
    ...
    <div class="form-group">
            ...
            <div class="col-md-4">
                {!! Form::select('address_country_id', HRis\Country::whereId(185)->lists('name', 'id'), $employee->address_country_id, ['class' => 'form-control chosen-select', $disabled]) !!}
            </div>
