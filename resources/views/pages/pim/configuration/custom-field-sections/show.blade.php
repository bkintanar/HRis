                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        {!! Form::open(['method' => 'POST', 'url' => Request::path(), 'class' => 'form-horizontal']) !!}
                            ...
                            <div class="form-group">
                                {!! Form::label('pim_custom_field_type_id', 'Type', ['class' => 'col-md-3 control-label']) !!}
                                <div class="col-md-9">
                                    {!! Form::select('pim_custom_field_type_id', HRis\Eloquent\CustomFieldType::lists('name', 'id'), null, ['class' => 'form-control chosen-select']) !!}
                                </div>
                            </div>
                            <div class="form-group">
