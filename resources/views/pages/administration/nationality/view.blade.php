                            ...
                            <tbody>
                                @if(count($nationalities))
                                    ...
                                    <tr id="nationality_{{$nationality->id}}">
                                        ...
                                        <td>
                                            <button rel="edit" id="{{$nationality->id}}" class="btn btn-primary btn-xs btn-warning" data-toggle="tooltip" data-placement="bottom" title="Edit" type="button"><i class="fa fa-paste"></i></button>
                                            <button rel="delete" id="{{$nationality->id}}" class="btn btn-primary btn-xs btn-danger" data-toggle="tooltip" data-placement="bottom" title="Delete" type="button"><i class="fa fa-trash"></i></button>
                                        </td>
                                    </tr>
                                    @endforeach
                                @else
