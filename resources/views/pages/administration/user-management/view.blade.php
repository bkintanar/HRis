                        ...
                        <tbody>
                            @if(count($users))
                                ...
                                <tr id="user_{{$user->id}}">
                                    ...
                                    <td>
                                        <button rel="edit" id="{{$user->id}}" class="btn btn-primary btn-xs btn-warning" title="Edit" type="button"><i class="fa fa-paste"></i></button>
                                        <button rel="delete" id="{{$user->id}}" class="btn btn-primary btn-xs btn-danger" title="Delete" type="button"><i class="fa fa-trash"></i></button>
                                    </td>
                                </tr>
                                @endforeach
                            @else
