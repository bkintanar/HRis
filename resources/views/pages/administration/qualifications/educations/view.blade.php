        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    @if($loggedUser->hasAccess('admin.qualifications.educations.create'))
                    <div class="">
                            ...
                            <tbody id="educationsBody">
                                @if(count($educations))
                                    ...
                                    <tr class="educationsList" id="education_{{$education->id}}">
                                        ...
                                        <td>
                                            @if($loggedUser->hasAccess('admin.qualifications.educations.update'))
                                            <button rel="edit" id="{{$education->id}}" class="btn btn-primary btn-xs btn-warning" title="Edit" type="button"><i class="fa fa-paste"></i></button>
                                            @endif
                                            @if($loggedUser->hasAccess('admin.qualifications.educations.delete'))
                                            <button rel="delete" id="{{$education->id}}" class="btn btn-primary btn-xs btn-danger" title="Delete" type="button"><i class="fa fa-trash"></i></button>
                                            @endif
                                        </td>
                                    </tr>
                                    @endforeach
