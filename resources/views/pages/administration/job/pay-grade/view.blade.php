                                ...
                                @if(count($payGrades))
                                    ...
                                    <tr class="payGradesList" id="payGrade_{{$payGrade->id}}">
                                        ...
                                        <td>
                                            ...
                                            <button rel="edit" id="{{$payGrade->id}}" class="btn btn-primary btn-xs btn-warning" title="Edit" type="button"><i class="fa fa-paste"></i></button>
                                            @endif
                                            @if($loggedUser->hasAccess('admin.job.pay-grades.delete'))
                                            <button rel="delete" id="{{$payGrade->id}}" class="btn btn-primary btn-xs btn-danger" title="Delete" type="button"><i class="fa fa-trash"></i></button>
                                            @endif
                                        </td>
                                    </tr>
                                    @endforeach
