                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        ...
                        <div class="dropdown profile-element"> <span>
                            ...
                            @else
                            <img alt="image" id="profile-image-nav" class="img-circle" src="/img/profile/default/{{$loggedUser->employee->job_title_id}}{{$loggedUser->employee->gender}}.png">
                            @endif
                             </span>
                            ...
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold">{{ $loggedUser->employee->first_name }} {{ $loggedUser->employee->last_name }}</strong>
                             </span> <span class="text-muted text-xs block">{{ $loggedUser->employee->jobTitle->name  }} <b class="caret"></b></span> </span> </a>
