...
class EmploymentStatusControllerTest extends TestCase
{
    ...
    protected $class_name = 'HRis\Api\Eloquent\EmploymentStatus';
    ...
    public function it_should_return_a_success_message_if_delete_is_successful()
    {
        ...
        $response = $this->delete('/api/admin/job/employment-status/'.$id, ['HTTP_Authorization' => 'Bearer '.$this->token])->response;
     ...
     *
     * +--------------------------------------------------------+
     * | POSITIVE TEST | GET /api/admin/job/employment-status/1 |
     * +--------------------------------------------------------+
     */
    public function it_should_return_a_single_instance_if_fetching_of_data_is_successful()
    {
        ...
        $response = $this->get('/api/admin/job/employment-status/1', ['HTTP_Authorization' => 'Bearer '.$this->token])->response;
     ...
     *
     * +----------------------------------------------------------+
     * | NEGATIVE TEST | GET /api/admin/job/employment-status/100 |
     * +----------------------------------------------------------+
     */
    public function it_should_return_an_error_if_fetching_of_data_is_unsuccessful()
    {
        ...
        $response = $this->get('/api/admin/job/employment-status/100', ['HTTP_Authorization' => 'Bearer '.$this->token])->response;
    ...
    public function it_should_return_an_error_if_delete_fails()
    {
        ...
        $response = $this->delete('/api/admin/job/employment-status/100', ['HTTP_Authorization' => 'Bearer '.$this->token])->response;
