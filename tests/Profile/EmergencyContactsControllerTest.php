...
class EmergencyContactsControllerTest extends TestCase
{
    ...
    public function it_should_return_a_success_message_if_delete_is_successful()
    {
        ...
        $response = $this->delete('/api/profile/emergency-contacts/'.$id, ['HTTP_Authorization' => 'Bearer '.$this->token])->response;
    ...
    public function it_should_return_an_error_if_delete_fails()
    {
        ...
        $response = $this->delete('/api/profile/emergency-contacts/100', ['HTTP_Authorization' => 'Bearer '.$this->token])->response;
